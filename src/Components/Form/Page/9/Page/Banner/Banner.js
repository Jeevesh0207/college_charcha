...
function Banner({ BasicData }) {
  ...
  return (
    <div className='Banner'
      style={{
        backgroundImage: `
        url(${(BasicData.bannerObj)?URL.createObjectURL(BasicData.bannerObj):BasicData.bannerImage})`,
    ...
    >
      <div className='Banner_Layer'>
        <div className='Banner_Poster'>
          <div className='Top'>
            <div className='Left'>
              <img src={(BasicData.logoObj)?URL.createObjectURL(BasicData.logoObj):BasicData.logoImage} alt='png'></img>
            </div>
            <div className='Right'>
